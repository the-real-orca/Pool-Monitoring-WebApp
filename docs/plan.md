...
### 26.2 UI Germanization + Übersicht rename + Settings version

Pure display string changes; no variable, route, or API renames.

| # | File | Change |
|---|------|--------|
| [x] 26.2.1 | `src/frontend/src/App.vue` | `navigationEntries`: `Live` → `Übersicht`, `Measurements` → `Messungen`. View key (`'live'` / `'form'`) and component imports unchanged. |
